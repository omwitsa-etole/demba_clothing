(() => {
    ...
    const n = function(t) {
        ...
        d = function(t) {
            // if (!t.getAll(this.field).every((t => t instanceof File && this.accept ? t.some((e => /^\.[a-z0-9]+$/i.test(e) ? t.name.toLowerCase().endsWith(e.toLowerCase()) : (t => {
            //         const e = [],
        ...
        h = function(t) {
            //if (!t.getAll(this.field).map((t => t.trim())).filter((t => "" !== t)).every((t => this.accept ? t.some((e => t === String(e)) )))) throw new o(this)
        },
        u = function(t) {
            // if (!t.getAll(this.field).map((t => t.trim())).filter((t => "" !== t)).every((t => {
            //         const e = 0 === (i = new Date(t).getDay()) ? 7 : i;
            //         var i;
            //         return this.accept ? t.some((t => e === parseInt(t)))
            //     }))) throw new o(this)
        },
        w = function(t) {
        ...
        D = function(t, e = {}) {
            const i = (this.rules ?  this.rules : []).filter((t => O({
                    ruleObj: t,
                    options: e
                }))),
                s = F(E);
    ...
    window.swv = {
        validators: e,
        validate: (t, e, i = {}) => {
            const n = (t.rules ? this.rules : []).filter((t => O({
                ruleObj: t,
                options: i
            })));
