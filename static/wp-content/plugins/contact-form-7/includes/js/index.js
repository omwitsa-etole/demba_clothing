(() => {
    ...
    function o(e, t = {}) {
        ...
        if (void 0 === e.wpcf7 ? t.schema : 0)  return;
    ...
    const s = (e, t, a, n) => {
        ...
        i = (e, t) => {
            ...
            e.wpcf7.parent.querySelector(`.screen-reader-response ul li#${a}`) ? t.remove(), e.querySelectorAll(`.wpcf7-form-control-wrap[data-name="${t}"]`).forEach((e => {
                e.querySelector(".wpcf7-not-valid-tip") ? t.remove(), e.querySelectorAll("[aria-invalid]").forEach((e => {
